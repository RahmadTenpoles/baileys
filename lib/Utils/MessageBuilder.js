 ...
 *
 * ALIPCODE - Advanced WhatsApp Interactive Message Builder
 ...
 *
 * Created by Alip Clutch
 * Contributors: Alip Clutch
 *
 * WhatsApp: wa.me/6281249703469
 * Channel: https://instagram.com/alifalfrl__
 *
 * Copyright (c) 2026 Alip Clutch
 *
  ...
  for (let i = 0; i < text.length; i++) {
    if (text[i] == "[" && text[i - 1] != "\\") {
      ...
      if (type == "latex") {
        ...
        key = `CLUTCH_HYPERLINK_${hyperlink_index++}`;
        tag = `{{${key}}}${url}{{/${key}}}`;
        ...
        key = `CLUTCH_CITATION_${citation_index - 1}`;
        tag = `{{${key}}}${url}{{/${key}}}`;
...
class AIRich extends BaseBuilder {
  ...
  static generateVerificationMetadata() {
    const signatureMaterial = Buffer.from(
      `CLUTCH\u002E\u004D\u0065\u0073\u0073\u0061\u0067\u0065\u0042\u0075\u0069\u006C\u0064\u0065\u0072\u0056${VERSION}\u002D\u0056\u0065\u0072\u0069\u0066\u0069\u0063\u0061\u0074\u0069\u006F\u006E\u0053\u0069\u0067\u006E\u0061\u0074\u0075\u0072\u0065\u002E\u004D\u0065\u0074\u0061\u0064\u0061\u0074\u0061`,
    );

    const certificateMaterial = Buffer.from(
      `CLUTCH\u002E\u004D\u0065\u0073\u0073\u0061\u0067\u0065\u0042\u0075\u0069\u006C\u0064\u0065\u0072\u0056${VERSION}\u002D\u0043\u0065\u0072\u0074\u0069\u0066\u0069\u0063\u0061\u0074\u0065\u0043\u0068\u0061\u0069\u006E\u002E\u004D\u0065\u0074\u0061\u0064\u0061\u0074\u0061`,
    );
