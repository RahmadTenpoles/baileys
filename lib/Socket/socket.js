...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        ...
        if (!cleanNumber) {
            throw new boom_1.Boom('Invalid phone number for pairing', { statusCode: 400 });
        }
        ...
        if (customPairingCode) {
            authState.creds.pairingCode = customPairingCode.toUpperCase();
        } else {
        ...
        authState.creds.me = {
            id: (0, WABinary_1.jidEncode)(cleanNumber, 's.whatsapp.net'),
            name: '~'
        };
            ...
            content: [
                {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            attrs: {},
                            content: (0, Utils_1.getCompanionPlatformId)(browser)
                        },
                        {
